...
for i, row in p.iterrows():
    if file_type == "binary":
        ...
        if pd.isna(P_1) == True:
            S_min1_05, S_min1_27, S_min1_fwhm, flux1, area, f_b1, SNR1_05, SNR1_27, SNR1_fwhm = None, None, None, None, None, None, None, None, None
        else:
            S_min1_05, S_min1_27, S_min1_fwhm, flux1, area, SNR1_05, SNR1_27, SNR1_fwhm = selection_effects.S_min(M_1, P_orb, e, a, P_1, P_dot1, B_1, x, y, z, vx, vy, vz, L1, T_rec, d_f, n_chan, freq, tau_samp, G, t_int)
            #print("Area", area)
        ...
        # check to see if each object is a neutron star, if it is not, save values as None, else compute the values
        if pd.isna(P_1) == True:
            S_min1_05, S_min1_27, S_min1_fwhm, flux1, area, f_b1, SNR1_05, SNR1_27, SNR1_fwhm = None, None, None, None, None, None, None, None
        else:
            S_min1_05, S_min1_27, S_min1_fwhm, flux1, area, SNR1_05, SNR1_27, SNR1_fwhm = selection_effects.S_min(M_1, P_orb, e, a, P_1, P_dot1, B_1, x, y, z, vx, vy, vz, L1, T_rec, d_f, n_chan, freq, tau_samp, G, t_int)
